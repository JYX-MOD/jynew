using UnityEngine;
using static Plugins.Auxiliary.AndroidBridge.AndroidTools;

namespace Plugins.Auxiliary.AndroidBridge
{
    /// <summary>
    ...
    {
        private readonly DirectoryPickCallback _callback;
        ...
        public DirectoryReceiveCallback(DirectoryPickCallback callback) : base(
